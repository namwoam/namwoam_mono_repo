...
FixedPoint operator+(const FixedPoint &rhs) const
{
    return FixedPoint(FixedPoint::GetRepr() + rhs.GetRepr());
};
...
FixedPoint operator*(const FixedPoint &rhs) const
{
    return FixedPoint(FixedPoint::GetRepr() * rhs.GetRepr() / FixedPoint::kInverseOfScalingFactor());
}

FixedPoint operator/(const FixedPoint &rhs) const{
    return FixedPoint((double)FixedPoint::GetRepr() / (double)rhs.GetRepr()  )
}